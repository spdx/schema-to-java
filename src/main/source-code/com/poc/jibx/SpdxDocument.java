 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://spdx.org/rdf/terms" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="SpdxDocument">
 *   &lt;xs:complexContent>
 *     &lt;xs:extension base="ns:SpdxElement">
 *       &lt;xs:all>
 *         &lt;xs:element type="ns:Review" name="reviewed" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element type="ns:ExtractedLicensingInfo" name="hasExtractedLicensingInfo" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element type="xs:string" name="specVersion"/>
 *         &lt;xs:element type="ns:AnyLicenseInfo" name="dataLicense"/>
 *         &lt;xs:element type="ns:Package" name="describesPackage" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element type="ns:ExternalDocumentRef" name="externalDocumentRef" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element type="ns:CreationInfo" name="creationInfo"/>
 *       &lt;/xs:all>
 *     &lt;/xs:extension>
 *   &lt;/xs:complexContent>
 * &lt;/xs:complexType>
