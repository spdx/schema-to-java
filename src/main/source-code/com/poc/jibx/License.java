 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://spdx.org/rdf/terms" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="License">
 *   &lt;xs:complexContent>
 *     &lt;xs:extension base="ns:SimpleLicensingInfo">
 *       &lt;xs:all>
 *         &lt;xs:element type="xs:string" name="standardLicenseHeaderTemplate" minOccurs="0"/>
 *         &lt;xs:element type="xs:string" name="licenseText"/>
 *         &lt;xs:element type="xs:boolean" name="isOsiApproved"/>
 *         &lt;xs:element type="xs:boolean" name="isFsfLibre" minOccurs="0"/>
 *         &lt;xs:element type="xs:string" name="standardLicenseTemplate" minOccurs="0"/>
 *         &lt;xs:element type="xs:string" name="standardLicenseHeader" minOccurs="0"/>
 *       &lt;/xs:all>
 *     &lt;/xs:extension>
 *   &lt;/xs:complexContent>
 * &lt;/xs:complexType>
