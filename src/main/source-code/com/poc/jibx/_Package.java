 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://spdx.org/rdf/terms" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="Package">
 *   &lt;xs:complexContent>
 *     &lt;xs:extension base="ns:SpdxItem">
 *       &lt;xs:all>
 *         &lt;xs:element type="xs:string" name="homepage" minOccurs="0"/>
 *         &lt;xs:element type="xs:string" name="supplier" minOccurs="0"/>
 *         &lt;xs:element type="ns:PackageVerificationCode" name="packageVerificationCode" minOccurs="0"/>
 *         &lt;xs:element type="ns:Checksum" name="checksum" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element type="xs:string" name="downloadLocation"/>
 *         &lt;xs:element type="xs:boolean" name="filesAnalyzed" minOccurs="0"/>
 *         &lt;xs:element type="ns:ExternalRef" name="externalRef" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element type="ns:File" name="hasFile" minOccurs="0" maxOccurs="unbounded"/>
 *         &lt;xs:element type="xs:string" name="summary" minOccurs="0"/>
 *         &lt;xs:element type="xs:string" name="originator" minOccurs="0"/>
 *         &lt;xs:element type="xs:string" name="packageFileName" minOccurs="0"/>
 *         &lt;xs:element type="xs:string" name="versionInfo" minOccurs="0"/>
 *         &lt;xs:element type="xs:string" name="sourceInfo" minOccurs="0"/>
